...
*/
  ...
  const MODULE_CONTENT_CUSTOMER_GREETING_GUEST       = 'Ben venuto  <strong>Visitatore!</strong> Vuoi accedere al <a role="button" class="btn btn-info btn-xs" href="%s">Tuo Profilo</a> o preferisci  <a role="button" class="btn btn-info btn-xs" href="%s">Creare un Nuovo Profilo</a>';
